...
class CarbonAwareThermostat(CoordinatorEntity, ClimateEntity):
    ...
    def extra_state_attributes(self):
        return {
            ...
            ATTR_TARGET_CLIMATE: self.coordinator.data.get(ATTR_TARGET_CLIMATE),
            ...
            ATTR_RECOMMENDED_POWER_LIST: self.coordinator.data.get(ATTR_RECOMMENDED_POWER_LIST, []),
            ATTR_SIMULATED_ROOM_TEMPERATURE_LIST: self.coordinator.data.get(ATTR_SIMULATED_ROOM_TEMPERATURE_LIST, []),
            ATTR_RECOMMENDED_POWER_NOW: self.coordinator.data.get(ATTR_RECOMMENDED_POWER_NOW),
            ...
            ATTR_PLOT_RECOMMENDED_POWER_HISTORY: self.coordinator.data.get(ATTR_PLOT_RECOMMENDED_POWER_HISTORY, []),
